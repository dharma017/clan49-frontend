    ...
    return <div>
        <div className="jumbotron jumbotron-fluid bg-dark py-0 mb-0">
          <div className="container clearfix">
            <img src={clan.badgeUrls.small} alt="" className="clanbadge rtl-mr-3 mt-3" />
          ...
          <div className="row">
            <div className="col-md-6">
              <table className="table table-inverse">
                <tbody>
                  <tr>
                    <th className="bg-dark text-muted">Clan Admission</th>
                  </tr>
                  <tr>
                    <th className="font-weight-normal">Members</th>
                    <td className="text-danger">
                      <span dir="ltr">{clan.members} / 50</span>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="text-info">
                      <span dir="ltr">{clan.requiredTrophies}</span>
                    </td>
                  </tr>
                  <tr>
            ...
            <div className="col-md-6">
              <table className="table table-inverse">
                <tbody>
                  <tr>
                    <th className="bg-dark text-muted">Clan Info</th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="text-success">
                      <span dir="ltr">{clan.warWins}</span>
                    </td>
                  </tr>
                  <tr>
