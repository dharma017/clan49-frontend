...
import PlayerRank from "../components/cr/PlayerRank.js";
import CrClanStats from "../components/cr/CrClanStats.js";
    ...
    return <Layout>
        ...
        <div className="cr-clan">
          ...
          <div className="clan-members">
            <Table bordered size="small" dataSource={memberDataSource} columns={memberColumns} scroll={{ x: 1300 }} pagination={{ pageSize: 50, hideOnSinglePage: true }} />
          </div>
        </div>
      </Layout>;
  }
